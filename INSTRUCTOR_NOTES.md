...
7. **SMTP Credentials** (EmailService.cs, lines 12-14)
   - Type: Email server credentials
   - Risk: Email spoofing

8. **Twilio Credentials** (AppConfig.cs, lines 18-19)
   - Type: Account SID and Auth Token
   - Risk: SMS/phone service abuse
   - Detection: GitHub Secret Scanning ✓

9. **JWT Secret Key** (AppConfig.cs, line 23)
   - Type: Token signing key
   - Risk: Token forgery, authentication bypass

10. **Encryption Keys** (AppConfig.cs, lines 26-27)
